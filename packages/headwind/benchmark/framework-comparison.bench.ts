...
function benchmarkHeadwindWithOutput(classes: string[]): string {
  const gen = new CSSGenerator(defaultConfig)
  for (const cls of classes) {
    gen.generate(cls)
  }
...
group('CSS Output Generation (1000 arbitrary values)', () => {
  ...
  bench('Headwind', () => {
    benchmarkHeadwindWithOutput(utilities)
  })
...
group('Typography Utilities (50 classes)', () => {
  bench('Headwind', () => {
    benchmarkHeadwind(typographyUtilities)
  })
...
group('Flexbox Utilities (50 classes)', () => {
  bench('Headwind', () => {
    benchmarkHeadwind(flexboxUtilities)
  })
...
group('Grid Utilities (55 classes)', () => {
  bench('Headwind', () => {
    benchmarkHeadwind(gridUtilities)
  })
...
group('Stacked Variants (40 classes)', () => {
  bench('Headwind', () => {
    benchmarkHeadwind(stackedVariants)
  })
...
group('Transform Utilities (55 classes)', () => {
  bench('Headwind', () => {
    benchmarkHeadwind(transformUtilities)
  })
...
group('Transition & Animation (30 classes)', () => {
  bench('Headwind', () => {
    benchmarkHeadwind(transitionUtilities)
  })
...
group('Border & Ring Utilities (45 classes)', () => {
  bench('Headwind', () => {
    benchmarkHeadwind(borderUtilities)
  })
...
group('Shadow & Effects (35 classes)', () => {
  bench('Headwind', () => {
    benchmarkHeadwind(effectUtilities)
  })
...
group('Full Project Simulation (~800 unique classes)', () => {
  ...
  bench('Headwind', () => {
    benchmarkHeadwindWithOutput(projectClasses)
  })
